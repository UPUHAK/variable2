public class Main {
    public static void main(String[] args) {
        ...
        var oneStudentPaper=totalPaper/(teacher1+teacher2+teacher3);
        ...
        int numberOfСlassroom=totalPaint/(oneClassroomWhitePaint+oneClassroomBrownPaint);
        int totalWhitePaint=oneClassroomWhitePaint*numberOfСlassroom;
        int totalBrownPaint=oneClassroomBrownPaint*numberOfСlassroom;
        System.out.println("В школе, где "+numberOfСlassroom+" классов, нужно "+totalWhitePaint+" банок белой краски и "+totalBrownPaint+" банок коричневой краски");
